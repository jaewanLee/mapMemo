package com.example.jaewanlee.mapmemo.Core.Service;
...
import com.example.jaewanlee.mapmemo.Core.BoradcastReceiver.RestartReceiver;
import com.example.jaewanlee.mapmemo.Core.BoradcastReceiver.ScreenReceiver;
...
//        Notification notification=new Notification(R.drawable.img_horizontal_test,"락스크린 실행",System.currentTimeMillis());
//        Notification notification = new Notification(R.drawable.ic_action_name, "서비스 실행됨", System.currentTimeMillis());
