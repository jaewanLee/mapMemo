...
public class SearchResultAdapter extends RecyclerView.Adapter<SearchResultAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_item_keyword_search, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            this.view=itemView;
            title = (TextView) itemView.findViewById(R.id.keyword_search_result_cardview_name_text);
            category = (TextView) itemView.findViewById(R.id.keyword_search_result_cardview_category_text);
            addr = (TextView) itemView.findViewById(R.id.keyword_search_result_cardview_addr_text);
            phone = (TextView) itemView.findViewById(R.id.keyword_search_result_cardview_phone_text);
            url = (TextView) itemView.findViewById(R.id.keyword_search_result_cardview_url_text);
        }
    }
