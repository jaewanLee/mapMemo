...
public class TimeBaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(product.dp.io.mapmo.R.layout.activity_time_base);

        Button mainButton = (Button) findViewById(product.dp.io.mapmo.R.id.time_standard_without);
        Button locationButton = (Button) findViewById(product.dp.io.mapmo.R.id.time_single_task);
        Button timeButton = (Button) findViewById(product.dp.io.mapmo.R.id.time_single_top);
        Button settingButton = (Button) findViewById(product.dp.io.mapmo.R.id.time_single_instance);
