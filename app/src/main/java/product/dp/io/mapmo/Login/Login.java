package product.dp.io.mapmo.Login;
...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(product.dp.io.mapmo.R.layout.activity_login);

        userIdTextView=(EditText)findViewById(product.dp.io.mapmo.R.id.login_id_editText);
        userPasswordTextView=(EditText)findViewById(product.dp.io.mapmo.R.id.login_pass_editText);
        logInButton=(LoginButton)findViewById(product.dp.io.mapmo.R.id.social_login_button);
