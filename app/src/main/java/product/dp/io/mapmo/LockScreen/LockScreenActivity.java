...
import product.dp.io.mapmo.KeywordSearchView.RecyclerViewDecoration;
...
public class LockScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(product.dp.io.mapmo.R.layout.activity_lockscreen);

        recyclerView = (RecyclerView) findViewById(product.dp.io.mapmo.R.id.lockscreen_mymemo_cardview);
        deepLinkImageView = (ImageButton) findViewById(product.dp.io.mapmo.R.id.lockscreen_deep_link);
