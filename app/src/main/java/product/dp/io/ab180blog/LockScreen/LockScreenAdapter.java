...
//        }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(product.dp.io.ab180blog.R.layout.cardview_item_lock_screen,parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            this.view = itemView;
            title = (TextView) itemView.findViewById(product.dp.io.ab180blog.R.id.lockscreen_near_memo_cardview_name_text);
            category = (TextView) itemView.findViewById(product.dp.io.ab180blog.R.id.lockscreen_near_memo_cardview_category_text);
            addr = (TextView) itemView.findViewById(product.dp.io.ab180blog.R.id.lockscreen_near_memo_cardview_addr_text);
            phone = (TextView) itemView.findViewById(product.dp.io.ab180blog.R.id.lockscreen_near_memo_cardview_phone_text);
            memo = (TextView) itemView.findViewById(product.dp.io.ab180blog.R.id.lockscreen_near_memo_cardview_memo_text);
        }
