...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(product.dp.io.ab180blog.R.layout.activity_login);

        userIdTextView=(EditText)findViewById(product.dp.io.ab180blog.R.id.login_id_editText);
        userPasswordTextView=(EditText)findViewById(product.dp.io.ab180blog.R.id.login_pass_editText);
        logInButton=(LoginButton)findViewById(product.dp.io.ab180blog.R.id.social_login_button);
