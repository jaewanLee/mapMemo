package product.dp.io.ab180blog.LockScreen.Service;
...
import product.dp.io.ab180blog.LockScreen.BoradcastReceiver.RestartReceiver;
import product.dp.io.ab180blog.LockScreen.BoradcastReceiver.ScreenReceiver;
...
public class ScreenService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        NotificationCompat.Builder mBuilder =   new NotificationCompat.Builder(this)
                .setSmallIcon(product.dp.io.ab180blog.R.drawable.ic_action_name) // notification icon
