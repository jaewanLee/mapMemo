...
public class MemoListShareAdapter  extends RecyclerView.Adapter<MemoListShareAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(product.dp.io.ab180blog.R.layout.recyclerview_item_share, parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(final View itemView) {
            super(itemView);
            memoTitle_tv = (TextView) itemView.findViewById(product.dp.io.ab180blog.R.id.memoListshare_title_TextView);
            memoCategory_iv = (ImageView) itemView.findViewById(product.dp.io.ab180blog.R.id.memoListshare_category_ImageView);
            createDate_tv = (TextView) itemView.findViewById(product.dp.io.ab180blog.R.id.memoListshare_date_TextView);
            memoContent_tv = (TextView) itemView.findViewById(product.dp.io.ab180blog.R.id.memoListshare_memoContent_TextView);
            isSharable=(CheckBox) itemView.findViewById(product.dp.io.ab180blog.R.id.memoListshare_share_CheckButton);
